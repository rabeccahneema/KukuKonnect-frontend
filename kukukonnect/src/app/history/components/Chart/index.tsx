  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF] ">
      <div className="flex-1 xl:p-5 ">
        <h1 className="text-3xl  sm:text-4xl lg:text-5xl  font-semibold text-[#084236] text-center mb-6 md:mb-8">
          Temperature and Humidity History
        </h1>
        <div className="flex flex-wrap gap-6 mb-6 xl:pl-7 ">
          <div className="flex bg-[#E5E7EB] rounded overflow-hidden shadow">
            <button
              onClick={() => setView("Graph")}
              className={`px-6 py-2 font-semibold transition ${
                view === "Graph"
                  ? "bg-[#D2914A] text-[#084236]"
                  : "bg-transparent text-[#a19c9c4b] cursor-pointer"
              }`}
            >
              Graph
            </button>
            <button
              ...
              className={`px-6 py-2 font-semibold transition ${
                view === "List"
                  ? "bg-[#D2914A] text-[#084236]"
                  : "bg-transparent text-[#a19c9c8e] cursor-pointer"
              }`}
            >
              List
            </button>
        ...
        <div className="   p-7 pb-4">
          ...
          {!loading && !error && view === "Graph" && (
            <div className="flex flex-col md:flex-row gap-12 justify-center ">
              <div className="flex-1 bg-[#FFFFFF] drop-shadow-lg sm:p-2 xl:p-8 ">
                <h2 className="text-xl font-medium pb-5 mb-8 text-center text-[#234534]">
                  Temperature
                </h2>
          ...
          {!loading && !error && view === "List" && <HistoryTable />}
        </div>
      </div>
    </div>
  );
