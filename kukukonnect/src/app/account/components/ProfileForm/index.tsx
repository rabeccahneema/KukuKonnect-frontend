      ...
      >
        <div className="border-b border-[#D2914A] pb-4 sm:pb-6 md:pb-8 mb-6 sm:mb-8 md:mb-8">
          <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-8 relative">
            <div className="relative w-20 h-20 sm:w-24 sm:h-24 md:w-36 md:h-36">
              <div
                className="absolute inset-0 rounded-full overflow-hidden shadow-md ring-4 ring-[#D2914A] ring-offset-1 sm:ring-offset-2 cursor-pointer"
            ...
            <div className="text-center sm:text-left mt-4 sm:mt-0">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-[#0B2C27] mb-2">
                Profile Photo
              </h2>
              <button
                type="button"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-x-12 md:gap-y-8 flex-grow">
          <div>
            <label
              htmlFor="firstName"
              className="block text-sm sm:text-base font-semibold text-[#0B2C27] mb-2"
            >
              First Name
            </label>
            <input
        ...
        {error && (
          <div className="text-center text-red-600 py-2 text-sm sm:text-base">
            {error}
          </div>
        )}

        <div className="mt-6 sm:mt-8 md:mt-10 flex items-center justify-center sm:justify-end">
          {isEditing && (
            <div className="flex flex-col sm:flex-row justify-center sm:justify-end gap-4 w-full sm:w-auto">
              <button
                type="button"
