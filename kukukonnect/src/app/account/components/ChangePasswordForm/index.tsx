...
export default function ChangePasswordForm({
 ...
 return (
   <motion.div
     ...
     className="bg-white rounded-3xl shadow-2xl p-6 sm:p-8 md:p-10 lg:p-12 xl:p-12 2xl:p-12 w-full h-full min-h-[700px] flex flex-col"
   >
     <form onSubmit={handleSubmit} className="flex flex-col">
       ...
       <div className="mt-4 sm:mt-8 md:mt-10 flex flex-col sm:flex-row justify-center sm:justify-center space-y-3 sm:space-y-0 sm:space-x-4">
         <button
           type="button"
           onClick={onCancel}
           className="px-6 sm:px-8 py-2.5 sm:py-3 cursor-pointer bg-white text-[#0B2C27] border-2 border-[#D2914A] rounded-lg font-semibold hover:bg-[#F5F0E6] transition-colors duration-200 text-sm sm:text-base"
         >
           Cancel
         </button>
         <button
           type="submit"
           disabled={loading}
           className="px-6 sm:px-8 py-2.5 sm:py-3 bg-[#D2914A] text-white rounded-lg cursor-pointer font-semibold hover:bg-[#B87E40] transition-colors duration-200 text-sm sm:text-base"
         >
